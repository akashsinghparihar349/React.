          ...
          <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl '>
            <button
             ...
             className='outline-none px-4 py-2 rounded-full text-white shadow-lg' style = {{backgroundColor : "red"}}>
              ...
              <button onClick={()=>setColor ("grey")} className='outline-none px-4 py-2 rounded-full text-white shadow-lg' style = {{backgroundColor : "grey"}}>
              grey
              </button>
              ...
              <button onClick={()=>setColor ("lavender")} className='outline-none px-4 py-2 rounded-full text-black shadow-lg' style = {{backgroundColor : "lavender"}}>
              lavender
              </button>
